...
public:
  ...
  Text                ModelPath; // Path for the spherical model file
  ...
  //                            set.
  //
  bool mOutputEnergy;         // Output Envelope Data
  bool mOutputDisplacement;     // Output Displacement Data
...
public:
  ...
  ModelParams() :
    ...
    GridSource       ( GRID_FROMFILE         ),
    CylinderRange    ( 600.0               ), // 600 km
    CompiledSelector ( 0                   ),
    ModelPath        ( "/Models/EarthModels/PREM/Simplified.csv") 
