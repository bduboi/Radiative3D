...
void SphereEarth(Grid & gr, const std::vector<Real> & args) {
  ...
  gr.WNode(0,0,1).SetAttributes( VpVs( 8.04, 4.48), 3.64, QMa, HSMa ); // Moho
  ...
  gr.WNode(0,0,8).SetAttributes( VpVs(13.66, 7.28), 5.77, QMa, HSMa );// CMB
  ...
  gr.WNode(0,0,12).SetAttributes( VpVs(10.29, 1e-5), 12.1, QCo, HSCo );// ICB
